...
//(alignof(UHandlerComponentFactory) == 0x000008, "Wrong alignment on UHandlerComponentFactory");
//(sizeof(UHandlerComponentFactory) == 0x000028, "Wrong size on UHandlerComponentFactory");
...
//(alignof(UPacketHandlerProfileConfig) == 0x000008, "Wrong alignment on UPacketHandlerProfileConfig");
//(sizeof(UPacketHandlerProfileConfig) == 0x000038, "Wrong size on UPacketHandlerProfileConfig");
//(offsetof(UPacketHandlerProfileConfig, Components) == 0x000028, "Member 'UPacketHandlerProfileConfig::Components' has a wrong offset!");
