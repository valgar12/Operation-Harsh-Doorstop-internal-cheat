...
public:
	...
	uint8                                         Pad_1509[0x10];                                    // 0x0008(0x0010)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
//(alignof(FKey) == 0x000008, "Wrong alignment on FKey");
//(sizeof(FKey) == 0x000018, "Wrong size on FKey");
//(offsetof(FKey, KeyName) == 0x000000, "Member 'FKey::KeyName' has a wrong offset!");
