...
//(alignof(IFontProviderInterface) == 0x000008, "Wrong alignment on IFontProviderInterface");
//(sizeof(IFontProviderInterface) == 0x000028, "Wrong size on IFontProviderInterface");
...
{
public:
	uint8                                         Pad_12A3[0x8];                                     // 0x0028(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
//(alignof(USlateWidgetStyleContainerBase) == 0x000008, "Wrong alignment on USlateWidgetStyleContainerBase");
//(sizeof(USlateWidgetStyleContainerBase) == 0x000030, "Wrong size on USlateWidgetStyleContainerBase");
...
{
public:
	uint8                                         Pad_12A4[0x48];                                    // 0x0028(0x0048)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
//(alignof(UFontBulkData) == 0x000008, "Wrong alignment on UFontBulkData");
//(sizeof(UFontBulkData) == 0x000070, "Wrong size on UFontBulkData");
...
//(alignof(IFontFaceInterface) == 0x000008, "Wrong alignment on IFontFaceInterface");
//(sizeof(IFontFaceInterface) == 0x000028, "Wrong size on IFontFaceInterface");
...
//(alignof(USlateTypes) == 0x000008, "Wrong alignment on USlateTypes");
//(sizeof(USlateTypes) == 0x000028, "Wrong size on USlateTypes");
...
//(alignof(USlateWidgetStyleAsset) == 0x000008, "Wrong alignment on USlateWidgetStyleAsset");
//(sizeof(USlateWidgetStyleAsset) == 0x000030, "Wrong size on USlateWidgetStyleAsset");
//(offsetof(USlateWidgetStyleAsset, CustomStyle) == 0x000028, "Member 'USlateWidgetStyleAsset::CustomStyle' has a wrong offset!");
...
//(alignof(ISlateWidgetStyleContainerInterface) == 0x000008, "Wrong alignment on ISlateWidgetStyleContainerInterface");
//(sizeof(ISlateWidgetStyleContainerInterface) == 0x000028, "Wrong size on ISlateWidgetStyleContainerInterface");
